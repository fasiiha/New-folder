        ...
        <div className="flex flex-col items-center justify-start w-[83%] gap-[25px]">
          ...
          <div className="flex flex-col items-center justify-start w-[94%] gap-[25px]">
            <div className="flex flex-row justify-start items-center w-full gap-[30px]">
              ...
              <div className="flex flex-col items-start justify-start w-[32%] gap-[19px]">
                ...
                <div className="flex flex-row justify-start w-full">
                  <div className="flex flex-col w-full gap-2.5 p-6 bg-white-A700 rounded-[25px]">
                    <div className="flex flex-row justify-between items-center w-full">
                      <Button size="2xl" className="w-[55px] !rounded-[27px]">
            ...
            <div className="flex flex-row justify-start w-full gap-[30px]">
              <div className="flex flex-col items-start justify-start w-[66%] gap-[15px]">
                ...
                <div className="flex flex-row justify-center w-full p-[26px] bg-white-A700 rounded-[25px]">
                  <div className="flex flex-col items-end justify-start w-[99%] ml-1.5 mr-[3px] gap-5">
                    <div className="flex flex-row justify-start w-[30%] gap-[30px]">
                    ...
                    <div className="flex flex-row justify-end w-full">
                      <div className="flex flex-col items-end justify-start w-full gap-2">
                        <div className="flex flex-row justify-start items-center w-full gap-2.5">
                          <div className="flex flex-col items-center justify-start w-[4%] gap-[21px]">
              ...
              <div className="flex flex-col items-start justify-start w-[32%] gap-[15px]">
                <Heading as="h5">Expense Statistics</Heading>
                <div className="flex flex-row justify-center w-full p-[31px] bg-white-A700 rounded-[25px]">
                  <div className="h-[259px] w-[94%] mx-[9px] relative">
                    <div className="flex flex-col items-center justify-start h-[119px] w-[119px] bottom-0 right-[12%] m-auto absolute">
                      <div className="flex flex-col items-center justify-start h-[119px] w-[119px] p-[23px] bg-indigo-200">
                        <Text
                          size="s"
                          as="p"
                          className="w-[66%] mb-[33px] !text-white-A700 text-center !font-medium leading-[18px]"
                        >
            ...
            <div className="flex flex-row justify-start items-center w-full gap-[30px]">
              <div className="flex flex-col items-start justify-start w-[41%] gap-[19px]">
                <Heading as="h6" className="!text-blue_gray-800">
                  Quick Transfer
                </Heading>
                <div className="flex flex-col items-center justify-center w-full gap-[27px] p-[25px] bg-white-A700 rounded-[25px]">
                  <div className="flex flex-row justify-between items-center w-full mt-2.5">
                    ...
                    <Button color="white_A700" className="w-[50px]">
              ...
              <div className="flex flex-col items-start justify-start w-[58%] gap-[17px]">
                <Heading as="h5">Balance History</Heading>
                <div className="flex flex-row justify-center w-full p-[23px] bg-white-A700 rounded-[25px]">
                  <div className="flex flex-row justify-center w-full mt-[3px] mb-1">
                    <div className="flex flex-row justify-center items-start w-full">
                      <div className="flex flex-col items-end justify-start w-[7%] gap-[30px]">
                        ...
                        <div className="flex flex-row justify-start items-center w-[95%] gap-[7px]">
                          <Text size="s" as="p" className="text-right">
                            200
                          </Text>
                          <div className="h-px w-[17%] bg-blue_gray-400" />
                        </div>
                        <div className="flex flex-row justify-start items-center w-[57%] gap-2">
                      ...
                      <div className="flex flex-col items-start justify-start w-[94%] mt-[7px] ml-[-1px] gap-px">
